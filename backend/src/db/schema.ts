...
export const users = sqliteTable("users", {
  ...
  preferences: text("preferences", { mode: "json" }).$type<{ targetLanguage: string; readerSettings?: { fontSize: number; fontFamily: string; lineHeight: number; showMargins: boolean; lineGap: number } }>(), // Drizzle handles JSON stringification
});
